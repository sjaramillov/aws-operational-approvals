# Aprobaciones operativas: galería del proyecto

`aws-operational-approvals` · Tres imágenes para explicar el propósito, el diseño y las decisiones del proyecto.

## Imagen conceptual

![Aprobaciones operativas](cover.png)
...
![Arquitectura de solución de Aprobaciones operativas](solution-architecture.png)
...
![Revisión de AWS Well-Architected aplicada a Aprobaciones operativas](well-architected.png)
